                       ...
                       solopt_t *solopt, stream_t *moni, char *errmsg)
{
    ...
    opt_t rtksrv_opt[]={
          ...
          {"pos2-arfilter",   3,  (void *)&(*prcopt).arfilter,   SWTOPT },
          ...
          {"pos2-varholdamb", 1,  (void *)&(*prcopt).varholdamb, "cyc^2"},
          {"pos2-gainholdamb",1,  (void *)&(*prcopt).gainholdamb,""     },
          {"pos2-arlockcnt",  0,  (void *)&(*prcopt).minlock,    ""     },
          {"pos2-minfixsats", 0,  (void *)&(*prcopt).minfixsats, ""	},
          {"pos2-minholdsats",0,  (void *)&(*prcopt).minholdsats,""	},
          {"pos2-mindropsats",0,  (void *)&(*prcopt).mindropsats,""     },
          {"pos2-rcvstds",    3,  (void *)&(*prcopt).rcvstds,	 SWTOPT },
          ...
          {"stats-weightmode",3,  (void *)&(*prcopt).weightmode, WEIGHTOPT},
          {"stats-eratio1",   1,  (void *)&(*prcopt).eratio[0],  ""     },
          {"stats-eratio2",   1,  (void *)&(*prcopt).eratio[1],  ""     },
          {"stats-eratio5",   1,  (void *)&(*prcopt).eratio[2],  ""     },
    ...
    saveopts("/sdcard/RtkGps/rtksrv_opt_before.conf","w","",rtksrv_opt);
    prcopt->ionoopt = 1;
    prcopt->tropopt = 1;
    prcopt->thresar[0] = 3;
    prcopt->minlock = 0;
    ...
    prcopt->initrst = 0;
 /*   prcopt->anttype[1] = "";*/
    saveopts("/sdcard/RtkGps/rtksrv_opt_after.conf","w","",rtksrv_opt);
